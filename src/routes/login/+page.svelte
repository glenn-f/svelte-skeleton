<script>
  ...
  export let data
  const { form, errors, enhance } = superForm(data.form, { taintedMessage: false, defaultValidator: 'keep' })
</script>

<div class="grid pt-5 gap-2">
  <div class="grid place-items-center mt-5">
    <form method="post" class="card w-80 p-4 grid grid-cols-2 place-items-center gap-3 hover:shadow-primary-500 hover:shadow-md transition-all" action="?/login" use:enhance>
      <h3 class="h3 col-span-2">Autenticar</h3>
