  ...
  <div class="container grid gap-3 bg-surface-100-800-token p-2 rounded-b-md">
    ...
    <div class="grid grid-cols-12 gap-2">
      ...
      <div class="col-span-12 flex items-center justify-center flex-wrap gap-2">
        ...
        <Button on:click={() => abrirIniciarEstorno()} text="Desfazer Saída" data-tooltip="Efetuar estorno total do processo" class="variant-filled-error" icon="fa-solid:undo-alt" />
        <Button
